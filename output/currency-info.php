...
return [
	...
	'ANG' => [
		...
		'pap'            => $global_formats["ls_dot_comma_ltr"],
	...
	'AZN' => [
		'az'             => $global_formats["rs_comma_dot_ltr"],
		'default'        => $global_formats["rs_comma_dot_ltr"],
		'az_IR'          => $global_formats["rs_comma_dot_ltr"],
	],
	'BAM' => [
		'bs'             => $global_formats["rs_comma_dot_ltr"],
	...
	'BIF' => [
		...
		'rn'             => $global_formats["rx_comma_dot_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'BND' => [
		'ms_Arab_BN'     => $global_formats["ls_comma_dot_ltr"],
	...
	'BRL' => [
		'pt'             => $global_formats["ls_comma_dot_ltr"],
		'default'        => $global_formats["ls_comma_dot_ltr"],
	...
	'BTN' => [
		'dz'             => $global_formats["lx_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'BYN' => [
		'be'             => $global_formats["rs_comma_space_ltr"],
	...
	'CNY' => [
		'bo'             => $global_formats["ls_dot_comma_ltr"],
		'mn'             => $global_formats["ls_dot_comma_ltr"],
		'ug'             => $global_formats["lx_dot_comma_ltr"],
		'zh'             => $global_formats["lx_dot_comma_ltr"],
	...
	'CZK' => [
		'cs'             => $global_formats["rs_comma_space_ltr"],
		'default'        => $global_formats["rs_comma_space_ltr"],
	...
	'DKK' => [
		'da'             => $global_formats["rs_comma_dot_ltr"],
		'fo'             => $global_formats["rs_comma_dot_ltr"],
		'kl'             => $global_formats["lx_comma_dot_ltr"],
		'default'        => $global_formats["rs_comma_dot_ltr"],
	...
	'EUR' => [
		...
		'frr'            => $global_formats["ls_dot_comma_ltr"],
		'fy'             => $global_formats["ls_comma_dot_ltr"],
		'ga'             => $global_formats["lx_dot_comma_ltr"],
		'gl'             => $global_formats["rs_comma_dot_ltr"],
		'hr'             => $global_formats["rs_comma_dot_ltr"],
		'it'             => $global_formats["rs_comma_dot_ltr"],
		'it_SM'          => $global_formats["rs_comma_dot_ltr"],
		'it_VA'          => $global_formats["rs_comma_dot_ltr"],
		'lb'             => $global_formats["rs_comma_dot_ltr"],
		'lt'             => $global_formats["rs_comma_space_ltr"],
		'lv'             => $global_formats["rs_comma_space_ltr"],
		'mt'             => $global_formats["lx_dot_comma_ltr"],
		'nl'             => $global_formats["ls_comma_dot_ltr"],
		'nl_BE'          => $global_formats["ls_comma_dot_ltr"],
		'oc_ES'          => $global_formats["ls_dot_comma_ltr"],
		'pt_PT'          => $global_formats["rs_comma_space_ltr"],
		'sk'             => $global_formats["rs_comma_space_ltr"],
		'sl'             => $global_formats["rs_comma_dot_ltr"],
		'sms'            => $global_formats["ls_dot_comma_ltr"],
		...
		'vec'            => $global_formats["ls_dot_comma_ltr"],
		'default'        => $global_formats["rs_comma_dot_ltr"],
	...
	'GBP' => [
		'cy'             => $global_formats["lx_dot_comma_ltr"],
		...
		'gd'             => $global_formats["lx_dot_comma_ltr"],
		'gv'             => $global_formats["lx_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'GEL' => [
		'ab'             => $global_formats["ls_dot_comma_ltr"],
		'ka'             => $global_formats["rs_comma_space_ltr"],
		'os'             => $global_formats["ls_comma_space_ltr"],
		'default'        => $global_formats["ls_dot_comma_ltr"],
	...
	'GHS' => [
		'ak'             => $global_formats["lx_dot_comma_ltr"],
		'ee'             => $global_formats["lx_dot_comma_ltr"],
		'en_GH'          => $global_formats["lx_dot_comma_ltr"],
		'gaa'            => $global_formats["ls_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'GTQ' => [
		...
		'quc'            => $global_formats["ls_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'HUF' => [
		'hu'             => $global_formats["rs_comma_space_ltr"],
		'default'        => $global_formats["rs_comma_space_ltr"],
		'hu_HU'          => $global_formats["rs_comma_space_ltr"],
	],
	'IDR' => [
		'id'             => $global_formats["lx_comma_dot_ltr"],
		'default'        => $global_formats["lx_comma_dot_ltr"],
	...
	'ILS' => [
		...
		'he'             => $global_formats["rs_dot_comma_rtl"],
		'default'        => $global_formats["rs_comma_dot_rtl"],
		'he_IL'          => $global_formats["rs_dot_comma_rtl"],
	],
	'INR' => [
		'as'             => $global_formats["ls_dot_comma_ltr"],
		'bn_IN'          => $global_formats["lx_dot_comma_ltr"],
		'dz'             => $global_formats["lx_dot_comma_ltr"],
		'en_IN'          => $global_formats["lx_dot_comma_ltr"],
		'gu'             => $global_formats["lx_dot_comma_ltr"],
		'hi'             => $global_formats["lx_dot_comma_ltr"],
		'kn'             => $global_formats["lx_dot_comma_ltr"],
		'kok'            => $global_formats["ls_dot_comma_ltr"],
		'mai'            => $global_formats["ls_dot_comma_ltr"],
		'ml'             => $global_formats["lx_dot_comma_ltr"],
		'mr'             => $global_formats["lx_dot_comma_ltr"],
		'ne_IN'          => $global_formats["ls_dot_comma_ltr"],
		'or'             => $global_formats["lx_dot_comma_ltr"],
		'sa'             => $global_formats["lx_dot_comma_ltr"],
		'sd'             => $global_formats["rs_comma_dot_ltr"],
		'ta'             => $global_formats["lx_dot_comma_ltr"],
		'te'             => $global_formats["lx_dot_comma_ltr"],
	...
	'IQD' => [
		...
		'az_Arab_IQ'     => $global_formats["ls_comma_dot_ltr"],
		'ckb'            => $global_formats["rs_comma_dot_rtl"],
		'default'        => $global_formats["rs_comma_dot_rtl"],
		'ckb_IQ'         => $global_formats["rs_comma_dot_rtl"],
	],
	'IRR' => [
		'fa'             => $global_formats["lx_comma_dot_rtl"],
		'default'        => $global_formats["lx_comma_dot_rtl"],
		'fa_IR'          => $global_formats["lx_comma_dot_rtl"],
	],
	'ISK' => [
		'is'             => $global_formats["rs_comma_dot_ltr"],
		'default'        => $global_formats["rs_comma_dot_ltr"],
	...
	'JPY' => [
		'ja'             => $global_formats["lx_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'KRW' => [
		'ko'             => $global_formats["lx_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'LKR' => [
		'si'             => $global_formats["lx_dot_comma_ltr"],
	...
	'MAD' => [
		...
		'tzm'            => $global_formats["rs_comma_space_ltr"],
		'default'        => $global_formats["rs_dot_comma_rtl"],
	...
	'MYR' => [
		'ms'             => $global_formats["lx_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'NGN' => [
		...
		'yo'             => $global_formats["lx_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'NOK' => [
		'nb'             => $global_formats["ls_comma_space_ltr"],
		'nb_SJ'          => $global_formats["ls_comma_space_ltr"],
		'nn'             => $global_formats["rs_comma_space_ltr"],
		'se'             => $global_formats["rs_comma_space_ltr"],
	...
	'NPR' => [
		'ne'             => $global_formats["ls_dot_comma_ltr"],
		'default'        => $global_formats["ls_dot_comma_ltr"],
	...
	'NZD' => [
		...
		'mi'             => $global_formats["ls_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'RON' => [
		'ro'             => $global_formats["rs_comma_dot_ltr"],
		'default'        => $global_formats["rs_comma_dot_ltr"],
		'ro_RO'          => $global_formats["rs_comma_dot_ltr"],
	],
	'RSD' => [
		'sr'             => $global_formats["rs_comma_dot_ltr"],
		'default'        => $global_formats["rs_comma_dot_ltr"],
		'sr_RS'          => $global_formats["rs_comma_dot_ltr"],
	],
	'RUB' => [
		'ba'             => $global_formats["ls_dot_comma_ltr"],
		'ce'             => $global_formats["rs_dot_comma_ltr"],
		'mdf'            => $global_formats["ls_dot_comma_ltr"],
		'myv'            => $global_formats["ls_dot_comma_ltr"],
		'ru'             => $global_formats["rs_comma_space_ltr"],
		'sah'            => $global_formats["rs_comma_space_ltr"],
		'tt'             => $global_formats["rs_comma_space_ltr"],
		'default'        => $global_formats["ls_dot_comma_ltr"],
	...
	'RWF' => [
		...
		'rw'             => $global_formats["ls_comma_dot_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
	...
	'SEK' => [
		'sv'             => $global_formats["rs_comma_space_ltr"],
		'default'        => $global_formats["rs_comma_space_ltr"],
	...
	'SOS' => [
		...
		'so'             => $global_formats["lx_dot_comma_ltr"],
		'default'        => $global_formats["rs_comma_dot_rtl"],
	...
	'THB' => [
		'th'             => $global_formats["lx_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
		'th_TH'          => $global_formats["lx_dot_comma_ltr"],
	],
	'TJS' => [
		'tg'             => $global_formats["rs_comma_space_ltr"],
		'default'        => $global_formats["rs_comma_space_ltr"],
		'tg_TJ'          => $global_formats["rs_comma_space_ltr"],
	],
	'TMT' => [
		'tk'             => $global_formats["rs_comma_space_ltr"],
		'default'        => $global_formats["rs_comma_space_ltr"],
	...
	'TOP' => [
		...
		'to'             => $global_formats["ls_dot_comma_ltr"],
		'default'        => $global_formats["lx_dot_comma_ltr"],
		'to_TO'          => $global_formats["ls_dot_comma_ltr"],
	],
	'TRY' => [
		'tr'             => $global_formats["lx_comma_dot_ltr"],
		'default'        => $global_formats["lx_comma_dot_ltr"],
	...
	'USD' => [
		'en'             => $global_formats["lx_dot_comma_ltr"],
	...
	'VND' => [
		'vi'             => $global_formats["rs_comma_dot_ltr"],
		'default'        => $global_formats["rs_comma_dot_ltr"],
	...
	'XAF' => [
		...
		'sg'             => $global_formats["lx_comma_dot_ltr"],
		'default'        => $global_formats["rs_comma_space_ltr"],
	...
	'XOF' => [
		'dyo'            => $global_formats["rs_comma_space_ltr"],
		...
		'wo'             => $global_formats["ls_comma_dot_ltr"],
		'default'        => $global_formats["rs_comma_space_ltr"],
	...
	'ZAR' => [
		'af'             => $global_formats["lx_comma_space_ltr"],
		'en_LS'          => $global_formats["lx_dot_comma_ltr"],
		'en_NA'          => $global_formats["lx_dot_comma_ltr"],
		'en_ZA'          => $global_formats["lx_dot_comma_ltr"],
		'nr'             => $global_formats["lx_comma_space_ltr"],
		'nso'            => $global_formats["ls_dot_space_ltr"],
		'ss'             => $global_formats["lx_comma_space_ltr"],
		'st'             => $global_formats["lx_comma_space_ltr"],
		'st_LS'          => $global_formats["lx_comma_space_ltr"],
		'tn'             => $global_formats["lx_dot_space_ltr"],
		'ts'             => $global_formats["ls_comma_space_ltr"],
		've'             => $global_formats["lx_comma_space_ltr"],
		'xh'             => $global_formats["lx_dot_space_ltr"],
		'zu'             => $global_formats["lx_dot_comma_ltr"],
		'default'        => $global_formats["lx_comma_space_ltr"],
